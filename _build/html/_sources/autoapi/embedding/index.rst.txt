...
.. py:class:: MLP(f_in, f_hidden, f_out, skip_connection=False)
...
.. py:class:: AddEdges(n_neighbors=None, cutoff=None, should_generate_edge_index=True)
   ...
   .. py:attribute:: should_generate_edge_index
      :value: True
   ...
   .. py:method:: add_edges(batch)


   .. py:method:: connect_fictitious_atom(batch)
      :staticmethod:



   .. py:method:: generate_edge_index(batch)
...
.. py:class:: InvariantFeatures(feature_name)
...
.. py:class:: NominalEmbedding(feature_name, n_features, n_types)

   Bases: :py:obj:`InvariantFeatures`
...
.. py:class:: PositionalEncoder(dim, length=10)
   ...
   .. py:method:: positional_encoding(x, rank)
...
.. py:class:: PositionalEmbedding(feature_name, n_features, length)
...
.. py:class:: SoftOneHotEncoder(n_rbf, max_radius, basis='cosine')
...
.. py:class:: SoftOneHotEmbedding(feature_name, n_features, max_radius, basis='cosine')
...
.. py:class:: CombineInvariantFeatures(n_features_in, n_features_out)
...
.. py:class:: AddEquivariantFeatures(n_features)
...
.. py:class:: MLPEmbedding(feature_name='node_feat', in_dim=None, hidden_dim=None, out_dim=None, skip_connection=False)
