...
from e3ti.model.embedding.equilibrium_embedder import MLPWithBN

class E3TIMLP(nn.Module):
    r"""
    A simple wrapper for the MLPwithBN from e3ti.model.embedding.equilibrium_embedder.
