...
.. py:class:: DDPMBase(score_model_class, score_model_kwargs, diffusion_steps=1000, lr=0.001, beta_scheduler=None)
   ...
   .. py:method:: training_step(batch, _)
   ...
   .. py:method:: validation_step(batch, _)
   ...
   .. py:method:: on_before_zero_grad(*args, **kwargs)
   ...
   .. py:method:: denoise_sample(t, x, epsilon_hat)


   .. py:method:: get_noise_img_and_epsilon(batch)


   .. py:method:: get_epsilon(batch)
...
.. py:class:: TLDDPM(score_model_class, score_model_kwargs, diffusion_steps=1000, lr=0.001, beta_scheduler=None)

   Bases: :py:obj:`DDPMBase`
   ...
   .. py:method:: sample(cond_batch, ode_steps=0)


   .. py:method:: get_loss(batch)
