...
.. py:class:: PaiNNTLScore(n_features=32, n_layers1=2, n_layers2=5, max_lag=1000, diff_steps=1000, n_neighbors=100, n_types=167, dist_encoding='positional_encoding')
   ...
   .. py:method:: forward(noise_batch, batch_0)
...
.. py:class:: PaiNNBase(n_features=128, n_layers=2, n_features_out=1, length_scale=10, dist_encoding='positional_encoding')
...
.. py:class:: Message(n_features=128, length_scale=10, dist_encoding='positional_encoding')
...
.. py:function:: multiply_first_dim(w, x)

.. py:class:: Update(n_features=128)
...
.. py:class:: EquivariantLinear(n_features_in, n_features_out)
...
.. py:class:: Readout(n_features=128, n_features_out=13)
