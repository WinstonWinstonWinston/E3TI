e3ti.model.equivariant.transformer
==================================

.. py:module:: e3ti.model.equivariant.transformer
...
.. py:class:: SE3Transformer(_max_radius, _number_of_basis, _hidden_size, act, max_neighbors, _irreps_sh, _irreps_input, _irreps_output, _irreps_key, _irreps_values, _irreps_query, _edge_basis, _periodic=False)
   ...
   .. py:attribute:: number_of_basis


   .. py:attribute:: irreps_sh


   .. py:attribute:: irreps_input


   .. py:attribute:: irreps_output


   .. py:attribute:: irreps_key


   .. py:attribute:: irreps_values


   .. py:attribute:: irreps_query


   .. py:attribute:: edge_basis
   ...
   .. py:method:: forward(f, pos, batch, cell_lengths=None)
...
.. py:class:: MultiSE3Transformer(input_channels, readout_channels, hidden_channels, key_channels, query_channels, edge_l_max, edge_basis, max_radius, number_of_basis, hidden_size, max_neighbors, act, num_layers, bn)
   ...
   .. py:attribute:: irreps_readout


   .. py:attribute:: lin_in


   .. py:attribute:: eg3nn_layers
